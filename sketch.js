...
var den//Distance between pm10 dots.
...
fill(255,0,100);
    ...
    text("Take a deep breath to survive!", windowWidth/2, windowHeight-50)
  }
  ...
  if(a>=2*windowHeight){
	...
	textSize(30);
  	textAlign(CENTER);
  	textFont('Oswald');
	text("Sorry, you can't survive in this city!", windowWidth/2, windowHeight-90)
    text("Try another one!", windowWidth/2, windowHeight-50)
 
  }if(a<1.3*windowHeight){
    fill(255,0,100);
    noStroke();
	textSize(30);
  	textAlign(CENTER);
  	textFont('Oswald');
	text("Press the mouse to breathe!", windowWidth/2+20, windowHeight-90)
